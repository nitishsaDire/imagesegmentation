...
class UNET_resnet34(nn.Module):
    def __init__(self, n_classes, dropout_p=0.4):
        ...
        self.upsample_3x3 = nn.Upsample((3,3), mode='nearest')
        ...
        self.conv2d_0d = self.conv2d(2048 + 1024, 1024, kernel=3, padding=1)
        self.conv2d_01d = self.conv2d(1024 + 512, 512, kernel=3, padding=1)
    ...
    def forward(self, x):
        ...
        x5d = self.conv2d_01d(torch.cat((x5e, self.upsample_7x7(x6d)), 1))  # 7x7,      512
